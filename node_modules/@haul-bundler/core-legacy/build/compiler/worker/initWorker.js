...
module.exports = function initWorker({
  ...
  const webSocket = new WebSocket(`ws://${socketAddress}/?platform=${platform}`);
  ...
  webSocket.on('open', async () => {
    ...
    compiler.on(Events.BUILD_FINISHED, ({
      error,
      stats
    }) => {
